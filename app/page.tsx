        ...
        <div className="mt-12 flex flex-col md:flex-row gap-6">
          ...
          <Link href="/ecommerce" className="flex-1">
            <div className="p-6 bg-gray-800 border border-gray-700 rounded-lg hover:bg-gray-700 transition flex flex-col h-56">
              ...
              <h2 className="text-xl font-semibold mb-2">Shop App</h2>
              <p className="text-gray-400 flex-1">An e-commerce platform</p>
            </div>
          </Link>
          <Link href="/forums" className="flex-1">
            <div className="p-6 bg-gray-800 border border-gray-700 rounded-lg hover:bg-gray-700 transition flex flex-col h-56">
              <div className="w-12 h-12 bg-gradient-to-br from-orange-400 to-pink-500 rounded-lg flex items-center justify-center mb-4">
                <svg
                  className="w-6 h-6 text-white"
                  fill="none"
                  stroke="currentColor"
              ...
              <h2 className="text-xl font-semibold mb-2">Forum App</h2>
              <p className="text-gray-400 flex-1">A community discussion app</p>
            </div>
          </Link>
        </div>
      </div>
